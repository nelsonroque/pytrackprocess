...
# ----------------------------------------------------------------------
def single_2sentinels(data_path,user_file,startFlag,endFlag,filestring,outType):
    import time
    import glob
    import re
...
# vars: frame, x, y, pupil
# ----------------------------------------------------------------------
def all_2sentinels(data_path,user_file,startFlag,endFlag,filestring,outType):
    import time
    import glob
    import re
...
# vars: frame, x, y, pupil
# ----------------------------------------------------------------------
def all_1sentinel(data_path,user_file,startFlag,filestring,outType):
    import time
    import glob
    import re
